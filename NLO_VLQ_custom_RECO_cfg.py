...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:NLO_VLQ_custom_HLT.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NLO_VLQ_custom_RECO.root'),
