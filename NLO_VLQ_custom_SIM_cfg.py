...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:NNLO_VLQ_custom.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NLO_VLQ_custom_SIM.root'),
