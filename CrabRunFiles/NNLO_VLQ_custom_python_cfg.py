...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/NNLO_VLQ_custom_python_fragment.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NNLO_VLQ_custom.root'),
...
#        filterName = cms.untracked.string('')
#    ),
#    fileName = cms.untracked.string('file:NNLO_VLQ_custom_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    #args = cms.vstring('/eos/user/b/bregnery/gridpacks/t23t23_Incl_tPythia_narrow_M1000_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
    ...
    #args = cms.vstring('root://cmseos.fnal.gov//store/user/bregnery/gridpacks/t23t23_Incl_tPythia_narrow_M1000_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
    #args = cms.vstring('/store/user/bregnery/gridpacks/t23t23_Incl_tPythia_narrow_M1000_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
    nEvents = cms.untracked.uint32(100),
    numberOfParameters = cms.uint32(1),
    outputFile = cms.string('cmsgrid_final.lhe'),
    #scriptName = cms.FileInPath('GeneratorInterface/LHEInterface/data/run_generic_tarball_cvmfs.sh')
    scriptName = cms.FileInPath('NNLO_VLQ_PrivateSamples/GenericTarball/data/run_generic_tarball_cvmfs.sh') # This line is super important, this script had to be modified so that it can be used on an EOS space
)
